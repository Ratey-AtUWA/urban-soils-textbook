...
mtext(side=2, line=1.6, text="Northing (UTM Zone 50, m)",
      font=2, cex=1.4)
# text(391242,6466632,labels="Charles Veryard\nReserve",col="darkgreen", font=3, cex=0.85)
text(391370,6466402,labels="Smith's Lake\nReserve",col="darkgreen", font=3, cex=0.85)
...
rect(391395, 6466640, 391415, 6466680, col = 1, border = 1, lwd = 6, ljoin = "round")
...
text(391536,6466620, labels="Charles St",col="grey40", cex=1, srt=-90, font=2)
...
rect(391040, 6466490, 391110, 6466532, col = 1, border = 1, lwd = 10, ljoin = "round")
text(c(391037,391035),c(6466509,6466510), pos = 4, labels=rep("Pb",2),
     cex = 3, font = 2, col = c(1,11))
box(lwd=2)
#
# make a vector of calculated quantiles for selected variable ####
q0 <- as.numeric(signif(quantile(sv17soil$Pb, 
...
points(sv17soil$Northing ~ sv17soil$Easting, pch=22, bg=2, cex=cex0[1], lwd=1,
       subset=sv17soil$Pb<q0[1])
points(sv17soil$Northing ~ sv17soil$Easting, pch=22, bg=3, cex=cex0[2], lwd=1,
       subset=sv17soil$Pb>q0[1]&sv17soil$Pb<q0[2])
points(sv17soil$Northing ~ sv17soil$Easting, pch=22, bg=4, cex=cex0[3], lwd=1,
       subset=sv17soil$Pb>q0[2]&sv17soil$Pb<q0[3])
points(sv17soil$Northing ~ sv17soil$Easting, pch=3, col=5, cex=cex0[4], lwd=2,
       subset=sv17soil$Pb>q0[3]&sv17soil$Pb<q0[4])
points(sv17soil$Northing ~ sv17soil$Easting, pch=4, col=6, cex=cex0[5], lwd=2,
       subset=sv17soil$Pb>q0[4]&sv17soil$Pb<q0[5])
points(sv17soil$Northing ~ sv17soil$Easting, pch=21, bg=7, cex=cex0[6], lwd=1,
       subset=sv17soil$Pb>q0[5]&sv17soil$Pb<q0[6])
points(sv17soil$Northing ~ sv17soil$Easting, pch=21, bg=8, cex=cex0[7], lwd=1,
       subset=sv17soil$Pb>q0[6]&sv17soil$Pb<q0[7])
points(sv17soil$Northing ~ sv17soil$Easting, pch=21, bg=9, cex=cex0[8], lwd=1,
       subset=sv17soil$Pb>q0[7])
#
...
legend(391035, 6466465, bty="o", pch=c(22,22,22,3,4,21,21,21), inset=0.025, 
       ...
       text.col = 11, box.col=10, bg = "grey87", y.intersp=1.1, 
       title=expression(bold("\u00A0Pb percentiles (mg/kg):\u00A0")), 
       legend=c(paste0("< 2% (",signif(min(sv17soil$Pb, na.rm=T),3),
                       " - ",q0[1],")"),
                ...
                paste0("> 98% (",q0[7]," - ",
                       signif(max(sv17soil$Pb, na.rm=T),3),")")), 
...
points(sv17soil$Northing ~ sv17soil$Easting,
       pch=seq(1,11)[sv17soil$Group],
       col=c(seq(1,10),"pink")[sv17soil$Group],
       lwd=c(3,3,3,3,3,3,2,2,2,2,2)[sv17soil$Group], 
       cex=c(1.8,rep(1.6,10))[sv17soil$Group])
summary(sv17soil[,6:7])
# points(as.numeric(tapply(sv17soil$Easting, sv17soil$Group, mean)),
#      as.numeric(tapply(sv17soil$Northing, sv17soil$Group, mean)),
#      pch=16, col="#FFFFFFA0", cex=1.6)
text(as.numeric(tapply(sv17soil$Easting, sv17soil$Group, mean)) +
       as.numeric(tapply(sv17soil$Easting, sv17soil$Group, sd)),
     as.numeric(tapply(sv17soil$Northing, sv17soil$Group, mean)),
     labels=names(tapply(sv17soil$Easting, sv17soil$Group, mean)),
     pos=4, col=seq(1,9), offset=0.65, cex=0.75) # 
legend(391035, 6466500, legend=levels(sv17soil$Group), title="Group",
